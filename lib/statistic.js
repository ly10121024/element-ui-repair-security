...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./packages/statistic/src/main.vue?vue&type=template&id=8cbee24c
var render = function () {
  var _vm = this
...
// CONCATENATED MODULE: ./packages/statistic/src/main.vue?vue&type=template&id=8cbee24c

// EXTERNAL MODULE: external "lodash-es"
var external_lodash_es_ = __webpack_require__(35);
...
/* harmony default export */ var mainvue_type_script_lang_js = ({
  ...
  methods: {
    ...
    dispose: function dispose() {
      ...
      if (!Object(external_lodash_es_["isNumber"])(value)) return false;
      if (this.precision) {
    ...
    formatTimeStr: function formatTimeStr(time) {
      ...
      ["s", 1000], // seconds
      ["S", 1]];
      var formatText = Object(external_lodash_es_["reduce"])(timeUnits, function (con, item) {
        var name = item[0];
        return con.replace(new RegExp(name + "+", "g"), function (match) {
          var sum = Object(external_lodash_es_["chain"])(time).divide(item[1]).floor(0).value();
          time -= Object(external_lodash_es_["multiply"])(sum, item[1]);
          return Object(external_lodash_es_["padStart"])(String(sum), String(match).length, 0);
        });
      }, format);
      var index = 0;
